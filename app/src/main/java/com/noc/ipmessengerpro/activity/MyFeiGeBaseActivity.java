...
import com.noc.ipmessengerpro.net.NetTcpFileReceiveThread;
import com.noc.ipmessengerpro.net.NetThreadHelper;
...
public abstract class MyFeiGeBaseActivity extends Activity {
	...
	private static Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case UsedConst.FILE_RECEIVED_WITH_INFO:{	//更新接收文件进度条
			...
			case UsedConst.FILE_RECEIVED_SUCCEEDED:{	//文件接收成功
